...
A Stata implementation of the Ball Mapper algorithm for Topological Data Analysis (TDA) as developed in Dlotko (2019). This command allows you to visualize the "shape" of high-dimensional data by creating a network of overlapping landmarks. Unlike dimensionality reduction techniques (like PCA or t-SNE), Ball Mapper preserves the original distances of your data, ensuring no information loss during the landmark discovery phase.
